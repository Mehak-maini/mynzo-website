...
export default function HomePageClient({ homePosts }: { homePosts: PostCard[] }) {
  ...
  useEffect(() => {
    ...
    const cardWidth = () => { return (viewport.offsetWidth - GAP * (VISIBLE - 1)) / VISIBLE; }
  ...
  return (
    <>
      ...
      <section className="hero">
        <BackgroundVideo src="/hero-loop.mp4" poster="/hero-poster.webp" eager />
      ...
      <section className="process-sec">
        ...
        <div className="process-inner">
          <div className="process-video-wrap">
            <BackgroundVideo src="https://mynzocarbon-website.s3.ap-south-1.amazonaws.com/process_from_land_to_verified_credits.mp4" />
          </div>
          <div>
      ...
      <section id="blogs" className="blogs2-sec">
        <div className="blogs2-inner">
          ...
          <div className="blogs2-grid" id="blogs-grid">
            {homePosts.map((p, i) => {
              const { tag, tagBg, tagColor, date, readTime, img: imgSrc } = p;
              return (
