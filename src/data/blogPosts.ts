...
export const STATIC_POSTS: StaticPost[] = [
  {
    ...
    content: `
      ...
      <h2>Start with four different quantities</h2>
      <ul>
      ...
      <h2>1. Define the area, period and carbon pools</h2>
      ...
      <h2>2. Build a field reference that matches the map</h2>
      ...
      <h2>3. Check usable observations, not just revisit frequency</h2>
      ...
      <h2>4. Estimate biomass and report uncertainty</h2>
      ...
      <h2>5. Compare like with like over time</h2>
      ...
      <h2>6. Prepare the evidence for independent review</h2>
      ...
      <h2>Questions to resolve before commissioning an estimate</h2>
      <h3>Can satellite data replace field measurements?</h3>
      ...
      <h3>Does an empty map cell mean there is no carbon?</h3>
